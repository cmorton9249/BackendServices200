...
namespace LibraryApi.Controllers
{
	public class BooksController : ControllerBase
	{
		...
		{
			bool updateSuccessful = await _bookCommands.UpdateTitle(bookId, title);
		...
		{
			var response = await _booksQuery.GetAllBooks();
			return Ok(response);
		}
		...
		{
			var book = await _booksQuery.GetBookById(bookId);
